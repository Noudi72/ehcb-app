    ...
    <div className="min-h-screen flex flex-col bg-[#f8fafc] font-sans">
      ...
      <main className="flex-1 px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center mb-2">
            <button
              ...
              className="flex items-center text-[#0a2240] hover:text-blue-900 transition"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clipRule="evenodd" />
              </svg>
              <span>Zurück zu Cardio Programmen</span>
            </button>
          </div>

          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-[#0a2240]">Cardio Programme verwalten</h1>
            <button
              onClick={handleAddProgram}
              className="px-4 py-2 bg-[#0a2240] text-white rounded-lg hover:bg-blue-900 transition"
            >
              Neues Programm
            </button>
          </div>
          ...
          {loading ? (
            <div className="text-center py-10">
              ...
              <p className="mt-3 text-gray-600">Lade Cardio-Programme...</p>
            </div>
          ) : (
            <div className="space-y-8">
            {cardioProgramme.map((program) => (
              <div key={program.id} className="bg-white rounded-lg shadow-md p-5 border border-gray-100">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h2 className="text-xl font-semibold text-[#0a2240]">{program.title}</h2>
                ...
                <h3 className="font-medium text-gray-700 mb-3">Übungen:</h3>
                    ...
                    >
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <p className="text-gray-600 mt-1">{workout.instruction}</p>
                          <div className="mt-2 grid grid-cols-2 gap-2 text-xs">
                            <div className="bg-gray-100 p-2 rounded">
                              <span className="font-medium">Intensität:</span> {workout.intensity}
                            </div>
                            <div className="bg-gray-100 p-2 rounded">
                              <span className="font-medium">Häufigkeit:</span> {workout.frequency}
                            </div>
                          </div>
                        </div>
            ...
            {cardioProgramme.length === 0 && (
              <div className="text-center py-8">
                <p className="text-gray-500 mb-4">Es sind noch keine Cardio-Programme definiert.</p>
                <button
                  onClick={handleAddProgram}
                  className="px-4 py-2 bg-[#0a2240] text-white rounded-lg hover:bg-blue-900 transition"
                >
        ...
        {editingProgram && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
              <h2 className="text-xl font-semibold mb-4">Programm bearbeiten</h2>
              <div className="space-y-4">
                <div>
        ...
        {isAddingProgram && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
              <h2 className="text-xl font-semibold mb-4">Neues Programm erstellen</h2>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Titel</label>
                  <input
        ...
        {editingWorkout && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
              <h2 className="text-xl font-semibold mb-4">Übung bearbeiten</h2>
              <div className="space-y-3">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Intensität</label>
                  <input
                    type="text"
        ...
        {isAddingWorkout && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
              <h2 className="text-xl font-semibold mb-4">Neue Übung hinzufügen</h2>
              <div className="space-y-3">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Name</label>
                  <input
