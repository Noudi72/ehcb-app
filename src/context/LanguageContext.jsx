...
const translations = {
  de: {
    ...
    "playerLogin": {
      ...
      "emailPlaceholder": "z.B. max.mustermann@email.com",
      "mainTeam": "Hauptteam",
  ...
  fr: {
    ...
    "playerLogin": {
      ...
      "emailPlaceholder": "p.ex. max.mustermann@email.com",
  ...
  en: {
    ...
    "playerLogin": {
      ...
      "email": "Email Address",
      "emailPlaceholder": "e.g. max.mustermann@email.com",
      "mainTeam": "Main Team",
      ...
      "step3": "You get access to the app after approval",
      "submit": "Submit Registration",
      "submitting": "Registering...",
      "alreadyRegistered": "You have already registered and are waiting for coach approval.",
